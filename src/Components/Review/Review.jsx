...
const Review = () => {
    ...
    const [itemsPerPage] = useState(6); // Estado para el número de elementos por página
                    ...
                    {currentItems.map((report) => (
                        <tr key={report.id}>  {/* Usar ID único como clave */}
                            ...
                            <td>
                                <Link 
                                    to={{
                                        pathname: `/create-informe/${report.id}`, // Ruta para editar el informe
                                        state: { studentInfo, report } // Pasar datos del estudiante y el informe
                                    }} 
